...
{
    public class AddDataTableToSlide : CodedWorkflow
    {
        [Workflow]
        public void Execute()
        {
            ...
            using (var pow = powerpoint.UsePowerPointPresentation("New Microsoft PowerPoint Presentation.pptx"))
            {
                ...
                var dataTable = excel.UseExcelFile("testExcel.xlsx").Sheet["Sheet1"].ReadRange(true,true);
                pow.AddDataTableToSlide(2,"Title 1",dataTable,TableAppendMode.CreateNewTable);
